        ...
        try{
            ...
            if(result != null){
                ...
                for(int i = 0; i < punches.size(); i++){
                    ...
                    adjustedPunch = punches.get(i);
                    
                    adjustedPunch.adjust(s);
                    
                    HashMap<String, String>  punchData = new HashMap<>();
                    
                    punchData.put("id", String.valueOf(adjustedPunch.getId()));
            
                    punchData.put("terminalid", String.valueOf(adjustedPunch.getTerminalid()));
            
                    punchData.put("eventtypeid", String.valueOf(adjustedPunch.getPunchtypeid()));
            
                    punchData.put("badgeid",(adjustedPunch.getBadgeid()));
            
                    punchData.put("eventdata", (adjustedPunch.getEventdata()));
                    
                    punchData.put("originaltimestamp", String.valueOf(adjustedPunch.getOriginaltimestamp().getTime()));
              
                    punchData.put("adjustedtimestamp", String.valueOf(adjustedPunch.getAdjustedtimestamp().getTime()));
                    
                    jsonData.add(punchData);
                    
                          
                }
                totalMinutes.put("totalminutes", String.valueOf(getMinutesAccrued(p)));
